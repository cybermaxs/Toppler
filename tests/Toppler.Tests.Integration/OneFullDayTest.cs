...
namespace Toppler.Tests.Integration
{
    ...
    public class OneFullDayTest : TestBase
    {
        ...
        public void OneFullDay_AllSeconds()
        {
            ...
            //seconds
            var secs = Topp.Ranking.GetTops(Granularity.Second, 60, current, this.TestDimension).Result;
            ...
            //minutes
            var mins = Topp.Ranking.GetTops(Granularity.Minute, 60,  current, this.TestDimension).Result;
            ...
            //hours
            var hours = Topp.Ranking.GetTops(Granularity.Hour, 24,  current, this.TestDimension).Result;
            ...
            //days
            var days = Topp.Ranking.GetTops(Granularity.Day, 1, current, this.TestDimension).Result;
        ...
        public void OneFullDay_GranularityEquality()
        {
            ...
            //last minute
            var lastmin_bysecs = Topp.Ranking.GetTops(Granularity.Second, 60,  current, this.TestDimension).Result;
            var lastmin_bymins = Topp.Ranking.GetTops(Granularity.Minute, 1,  current, this.TestDimension).Result;
            ...
            //last hour
            var lasthour_bymins = Topp.Ranking.GetTops(Granularity.Minute, 60,  current, this.TestDimension).Result;
            var lasthour_byhours = Topp.Ranking.GetTops(Granularity.Hour, 1,  current, this.TestDimension).Result;
            ...
            //last day
            var lastday_byhours = Topp.Ranking.GetTops(Granularity.Hour, 24, current, this.TestDimension).Result;
            var lastday_bydays = Topp.Ranking.GetTops(Granularity.Day, 1, current, this.TestDimension).Result;
