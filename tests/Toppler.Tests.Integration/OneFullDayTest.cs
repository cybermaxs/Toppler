...
namespace Toppler.Tests.Integration
{
    ...
    public class OneFullDayTest : TestBase
    {
        ...
        public void OneFullDay_AllSeconds()
        {
            ...
            //seconds
            var secs = TopplerClient.Ranking.GetTops(Granularity.Second, 60, -1, current, this.TestDimension).Result;
            ...
            //minutes
            var mins = TopplerClient.Ranking.GetTops(Granularity.Minute, 60, -1, current, this.TestDimension).Result;
            ...
            //hours
            var hours = TopplerClient.Ranking.GetTops(Granularity.Hour, 24, -1, current, this.TestDimension).Result;
            ...
            //days
            var days = TopplerClient.Ranking.GetTops(Granularity.Day, 1, -1, current, this.TestDimension).Result;
        ...
        public void OneFullDay_GranularityEquality()
        {
            ...
            //last minute
            var lastmin_bysecs = TopplerClient.Ranking.GetTops(Granularity.Second, 60, -1, current, this.TestDimension).Result;
            var lastmin_bymins = TopplerClient.Ranking.GetTops(Granularity.Minute, 1, -1, current, this.TestDimension).Result;
            ...
            //last hour
            var lasthour_bymins = TopplerClient.Ranking.GetTops(Granularity.Minute, 60, -1, current, this.TestDimension).Result;
            var lasthour_byhours = TopplerClient.Ranking.GetTops(Granularity.Hour, 1, -1, current, this.TestDimension).Result;
            ...
            //last day
            var lastday_byhours = TopplerClient.Ranking.GetTops(Granularity.Hour, 24, -1, current, this.TestDimension).Result;
            var lastday_bydays = TopplerClient.Ranking.GetTops(Granularity.Day, 1, -1, current, this.TestDimension).Result;
