...
namespace Toppler.Tests.Integration
{
    ...
    public class SingleEventSourceTest : TestBase
    {
        ...
        public void SingleEventSource_SingleHit_RandomContext()
        {
            ...
            var overall = TopplerClient.Ranking.GetOverallTops(Granularity.Day, dimensions: new string[] { this.TestDimension }).Result;
        ...
        public void SingleEventSource_MultiplesHits_RandomContext()
        {
            ...
            var overall = TopplerClient.Ranking.GetOverallTops(Granularity.Day, 60, dimensions: new string[] { this.TestDimension }).Result;
        ...
        public void SingleEventSource_MultiplesHits_MultiContext()
        {
            ...
            //all contexts
            var alltops = TopplerClient.Ranking.GetOverallTops(Granularity.Day, 1, -1, current, null).Result;
            ...
            //v1
            var topsv1 = TopplerClient.Ranking.GetTops(Granularity.Day, 1, -1, current, this.TestDimension + "-v1").Result;
            ...
            //v2
            var topsv2 = TopplerClient.Ranking.GetTops(Granularity.Day, 1, -1, current, this.TestDimension + "-v2").Result;
            ...
            //v3
            var topsv3 = TopplerClient.Ranking.GetTops(Granularity.Day, 1, -1, current, this.TestDimension + "-v3").Result;
